"""Check that the data files exist and are readable, nonempty,
and well-formatted.
...
class TestDataFiles(unittest.TestCase):
    ...
    def test_data_files_are_well_formatted(self):
        ...
        try:
            ...
            raise self.failureException(f"{self.neo_file!r} "
                                        f"is not a well-formated CSV.") \
                from err
        ...
        try:
            ...
            raise self.failureException(f"{self.cad_file!r} "
                                        f"is not a valid JSON document.") \
                from err
